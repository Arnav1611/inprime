...
Where the bureau record itself is wrong — a loan that is not theirs, a wrong status — raise it as a
persistent alert, not a one-time line in a thread. It stays until resolved.
